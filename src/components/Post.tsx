                ...
                <div className='flex gap-3 mb-2'>
                    ...
                    <div className='flex items-center gap-1.5'>
                        <svg 
                            ...
                            className={`size-7 hover:text-inknity-purple hover:cursor-pointer transition-all duration-300 
                                ${wasLiked ? "text-red-500" : "text-gray-400"}`}
                    ...
                    <div className='flex items-center gap-1.5'>
                        <svg 
                            ...
                            className='size-7 hover:text-inknity-purple hover:cursor-pointer md:transition-all md:duration-300 text-gray-400'
                        >
                            <path 
                                strokeLinecap='round' 
                                strokeLinejoin='round' 
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            onClick={handleSave}
                            className={`transition cursor-pointer hover:text-inknity-purple ${
                                wasSaved ? "text-inknity-purple" : "text-gray-400"
                            }`}
                        >
                            {wasSaved ? (
